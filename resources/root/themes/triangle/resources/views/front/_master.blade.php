...
<head>
    ...
    <title>{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}</title>
...
<div class="wrapper" id="site_wrapper">
    ...
    <header class="header" id="header">
        @include('edutalk-theme::front._partials.header')
    </header>

    @include('edutalk-theme::front._partials.flash-messages')
    ...
    <footer class="footer" id="footer">
        @include('edutalk-theme::front._partials.footer')
    </footer>
