        ...
        'web' => [
            'get' => [
                [
                    ...
                    [
                        'as' => 'front.search.get',
                        'uses' => \Edutalk\Themes\Triangle\Http\Controllers\Pages\SearchController::class . '@handle',
                    ]
                ],
                [
                    '/{slug?}',
                    [
                        ...
                        'uses' => 'Edutalk\Base\Pages\Http\Controllers\Front\ResolvePagesController@handle',
                        'where' => [
                            'slug' => '[-A-Za-z0-9]+'
                        ]
                    ]
