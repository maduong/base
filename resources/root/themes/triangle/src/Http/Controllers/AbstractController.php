<?php namespace Edutalk\Themes\Triangle\Http\Controllers;
...
use Edutalk\Base\Http\Controllers\BaseFrontController;
    ...
    protected function getMenu($type, $relatedId)
    {
        $menuHtml = $this->cacheService
            ...
            ->retrieveFromCache(function () use ($type, $relatedId) {
                return Edutalk_render_menu(get_setting('main_menu', 'main-menu'), [
                    'id' => '',
