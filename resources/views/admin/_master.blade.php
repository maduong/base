...
<head>
    ...
    <meta charset="utf-8"/>
    <title>{{ $pageTitle or 'Dashboard' }} | Edutalk</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta content="Admin dashboard - Edutalk" name="description"/>
...
<div class="wrapper">
    {{--BEGIN Header--}}
    @include('edutalk-core::admin._partials.header')
    {{--END Header--}}

    {{--BEGIN Sidebar--}}
    @include('edutalk-core::admin._partials.sidebar')
    {{--END Sidebar--}}

    <div class="content-wrapper">
        <section class="content-header">
            {{--BEGIN Page title--}}
            @include('edutalk-core::admin._partials.page-title')
            {{--END Page title--}}
            {{--BEGIN Breadcrumbs--}}
            @include('edutalk-core::admin._partials.breadcrumbs')
            {{--END Breadcrumbs--}}
        </section>

        <section class="content">
            {{--BEGIN Flash messages--}}
            @include('edutalk-core::admin._partials.flash-messages')
            {{--END Flash messages--}}
    ...
    {{--BEGIN Footer--}}
    @include('edutalk-core::admin._partials.footer')
    {{--END Footer--}}

    {{--BEGIN control sidebar--}}
    @include('edutalk-core::admin._partials.control-sidebar')
    {{--END control sidebar--}}
</div>

{{--Modals--}}
@include('edutalk-core::admin._partials.modals')
