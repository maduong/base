...
<!-- Google+ -->
<meta itemprop="name" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}">
...
<meta name="twitter:title" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}">
...
<!-- Open Graph data -->
<meta property="og:title" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}">
...
<meta property="og:site_name" content="{{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}">
...
<meta property="article:section" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Edutalk') ?: 'Edutalk' }}">
