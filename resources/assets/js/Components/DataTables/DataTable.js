                ...
                ajax: { // define ajax settings
                    ...
                    dataSrc: function (res) { // Manipulate the data returned from the server
                        if (res.customActionMessage) {
                            Edutalk.showNotification(res.customActionMessage, res.customActionStatus);
                        }
                        ...
                        Edutalk.unblockUI(_self.$tableContainer);

                        return res.data;
                    },
                    error: function () { // handle general connection errors
                        this.onError.call(undefined, _self);
                        Edutalk.showNotification(this.dataTableParams.language.ajaxRequestGeneralError, 'danger');

                        Edutalk.unblockUI($tableContainer);
                    }
                },
