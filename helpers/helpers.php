...
if (!function_exists('admin_bar')) {
    /**
     * @return \Edutalk\Base\Support\AdminBar
     */
    function admin_bar()
    {
        return \Edutalk\Base\Facades\AdminBarFacade::getFacadeRoot();
    }
}

if (!function_exists('dashboard_menu')) {
    /**
     * @return \Edutalk\Base\Menu\Support\DashboardMenu
     */
    function dashboard_menu()
    {
        return \Edutalk\Base\Menu\Facades\DashboardMenuFacade::getFacadeRoot();
    }
}
...
if (!function_exists('load_module_helpers')) {
    ...
    {
        \Edutalk\Base\Support\Helper::loadModuleHelpers($dir);
    }
}
...
if (!function_exists('is_admin_panel')) {
    ...
    function is_admin_panel()
    {
        ...
        if ($segment === config('edutalk.admin_route', 'admincp')) {
            return true;
        }
