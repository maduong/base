<?php namespace Edutalk\Base\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Filesystem\Filesystem;
use Edutalk\Base\ACL\Models\Role;
use Edutalk\Base\Providers\InstallModuleServiceProvider;
...
class InstallCmsCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install Edutalk';
    ...
    public function handle()
    {
        ...
        $this->info("\nEdutalk installed. Current version is " . config('edutalk.version'));
    }
    ...
    protected function createAdminUser()
    {
        ...
        $user->email = $this->ask('Your email', 'admin@Edutalk.com');
    ...
    {
        $modules = get_modules_by_type('base')->where('namespace', '!=', 'Edutalk\Base');
