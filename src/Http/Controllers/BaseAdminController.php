...
{
    /**
     * @var \Edutalk\Base\Support\Breadcrumbs
     */
    public $breadcrumbs;

    /**
     * @var \Edutalk\Base\Users\Models\User
     */
    protected $loggedInUser;

    /**
     * @var \Edutalk\Base\AssetsManagement\Assets
     */
    public $assets;
    ...
    public function __construct()
    {
        ...
        $this->middleware(function (Request $request, $next) {
            $this->breadcrumbs = \Breadcrumbs::setBreadcrumbClass('breadcrumb')
                ->setContainerTag('ol')
                ->addLink('Edutalk', route('admin::dashboard.index.get'), '<i class="icon-home mr5"></i>');
