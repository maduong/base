<?php namespace Edutalk\Base\Http\DataTables;
...
abstract class AbstractDataTables
{
    ...
    public $dataTableView = 'edutalk-core::admin._components.datatables.table';
    ...
    protected function view()
    {
        ...
        add_action(BASE_ACTION_FOOTER_JS, function () use ($selector, $columns, $ajaxUrl) {
            echo view('edutalk-core::admin._components.datatables.script-renderer', compact(
